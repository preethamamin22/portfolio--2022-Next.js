...
async function getPost(slug) {
  const res = await fetch(
   `https://ghost-production-fd54.up.railway.app/ghost/api/v3/content/posts/slug/${slug}?key=${CONTENT_API_KEY}&fields=title,slug,html,feature_image,published_at,reading_time`
  ).then((res) => res.json());
