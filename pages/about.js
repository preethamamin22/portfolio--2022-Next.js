    ...
    <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
      ...
      <div className="mb-8 prose leading-6 text-gray-600 dark:text-gray-400">
        ...
        <p style={{ textDecoration: "line-through" }}>
          {" "}
          I'm a UI/UX Designer living in Kodagu, India. I love to build
          and design things. I have experience in creating UI designs for 
          mobile & desktop applications, web design, user experience, and visual
          design. I have worked extensively in teams and alone.
        </p>{" "}
        <p>
          WTF? Sound human Preetham. Okay, here you go. Huh, so you're
        ...
        <p>
          ...
          humble beginnings. Until 2020, the only thing I knew about computers
          ...
          have to Google the basic stuff like adding inline CSS in HTML.
        </p>{" "}
      </div>
      <h2 className="font-bold text-3xl tracking-tight mb-4 text-black dark:text-white">
        Conference Talks
      </h2>
      <Talk title="Intro to Figma" link="https://twitter.com/PreethamAmin__">
