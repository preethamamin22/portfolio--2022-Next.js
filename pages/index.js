  ...
  return (
    <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 ">
      ...
      <h2 className="prose text-gray-600 dark:text-gray-400 mb-6">
        I am a Bangalore based Product Designer. I love designing and building
        for the web, you can read more about what I do and things I love over my
        website preetham.com.
      </h2>
